# mulle-craft Documentation Process Guide

## Overview

This document outlines the systematic process for creating comprehensive command documentation for mulle-craft. Based on practical experience with documentation creation, it provides clear guidelines for what to write, what to avoid, and the step-by-step process to follow.
...
mulle-craft <command> <arguments>
mulle-craft <command> --help
mulle-craft <command> --verbose

# Good: Workflow examples
mulle-craft <command1> <args>
mulle-craft <command2> <args>
mulle-craft <command3> <args>
```
...
#### [Command Category 1]
- [ ] `mulle-craft <command> <args>` : Command description
- [ ] `mulle-craft <command> <args>` : Command description
...
### Notes
- This is a new documentation session for mulle-craft
